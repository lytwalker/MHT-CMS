...
class TypesControllerTest < ActionController::TestCase
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post :create, type: { banner: @type.banner, description: @type.description, name: @type.name, url: @type.url }
    end
  ...
  test "should update type" do
    patch :update, id: @type, type: { banner: @type.banner, description: @type.description, name: @type.name, url: @type.url }
    assert_redirected_to type_path(assigns(:type))
  end
